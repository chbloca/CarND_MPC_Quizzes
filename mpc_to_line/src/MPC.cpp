 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for(int t = 0; t < N; ++t){
        ...
        fg[0] += CppAD::pow(vars[v_start + t], 2); // velocity error
    }
    ...
    // Minimize the value gap between sequential actions
    for(int t = 0; t < N + 2; ++t){
    ...
    for (int t = 1; t < N; ++t) {
      ...
      AD<double> f0 = coeffs[0] + coeffs[1] + coeffs[2];
      ...
      fg[1 + epsi_start + t] = epsi1 - (epsi0 - psides0 + v0 / Lf * delta0 * dt);
    }
  }
};
